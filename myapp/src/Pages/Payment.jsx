import {
  Button, useToast, Card, Flex, Grid, Heading, Image, Radio, Box, Text, FormControl, Input, Stack, FormLabel, RadioGroup, FormHelperText,
  Popover,
  PopoverTrigger,
  PopoverContent,
  PopoverBody,
          ...
          <Flex justify={'space-between'} align={'center'} mt={6} mb={25} flexDirection={{ xl: 'row', lg: 'row', base: 'column' }}>
            ...
            <Flex align={'center'} gap={10} flexDirection={{ xl: 'row', lg: 'row', base: 'column' }}>
              <Box w={'100px'} bg='blue.300' borderRadius={'12px'}>
                {/* <Image src={selectedProduct && selectedProduct.img[0]} /> */}
                <Image src="https://m.media-amazon.com/images/I/61WqF8Y6HTL._AC_UY218_.jpg"/>
              </Box>
              <Box>
                <Heading size={{ xl: 'md', lg: 'md', base: 'sm' }}>boAt Rockerz 400 Bluetooth On Ear</Heading>
                {/* <Text fontWeight={'bold'} mt={2} size={{ xl: 'md', lg: 'md', base: 'sm' }}>Color: {selectedProduct && selectedProduct.color}</Text> */}
              </Box>
            </Flex>
            <Box textAlign={'right'}>
              <Heading size={{ xl: 'md', lg: 'md', base: 'sm' }} mr={5}>$ 549{selectedProduct && selectedProduct.price}</Heading>
              <Text fontWeight={'bold'} mr={5} size={{ xl: 'md', lg: 'md', base: 'sm' }}>Quantity: 1{selectedProduct && selectedProduct.quantity}</Text>
            </Box>
          </Flex>
        </Box>
